    ...
    <div class="container mx-auto py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'supervisor' || auth()->user()->rol === 'usuario')
                <!-- Card de Artículos -->
                <div
                    class="bg-gradient-to-r from-blue-500 to-blue-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'supervisor' || auth()->user()->rol === 'usuario')
                <!-- Card de Almacenes -->
                <div
                    class="bg-gradient-to-r from-green-500 to-green-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'supervisor' || auth()->user()->rol === 'usuario')
                <!-- Card de Inventario -->
                <div
                    class="bg-gradient-to-r from-purple-500 to-purple-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'usuario')
                <!-- Card de Entradas -->
                <div
                    class="bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'usuario')
                <!-- Card de Salidas -->
                <div
                    class="bg-gradient-to-r from-red-500 to-red-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
            ...
            @if (auth()->user()->rol === 'admin' || auth()->user()->rol === 'supervisor')
                <div
                    class="bg-gradient-to-r from-cyan-500 to-cyan-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
            ...
            @if (auth()->user()->rol === 'admin')
                <!-- Card de Usuarios -->
                <div
                    class="bg-gradient-to-r from-teal-500 to-teal-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
                        <path
            ...
            @if (auth()->user()->rol === 'admin')
                <!-- Card de Proveedores -->
                <div
                    class="bg-gradient-to-r from-indigo-500 to-indigo-400 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-4" viewBox="0 0 24 24" fill="white">
