<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-600 relative overflow-hidden">
        <!-- Gradiente animado -->
        <div class="absolute inset-0 bg-gradient-to-r from-lime-500 via-emerald-500 to-teal-500 animate-gradient-move z-0"></div>

        <!-- Contenido centrado -->
        <div class="flex flex-col md:flex-row w-full max-w-4xl bg-white shadow-lg rounded-lg relative z-10">
            <!-- Columna de la imagen -->
            <div class="hidden md:block md:w-1/2">
                <img src="{{ asset('images/almacenes.jpg') }}" alt="Almacenes" class="w-full h-full object-cover rounded-l-lg">
            </div>
            ...
            <div class="w-full md:w-1/2 p-6">
                ...
                <p class="text-sm text-center text-gray-500 mb-4">Bienvenido de nuevo, por favor ingresa tus credenciales</p>
